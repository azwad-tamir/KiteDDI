'''
This file trains the KiteDDI model on Dataset2 for the U1 split
'''
...
def main():
    ...
    with open('./data/db2_data.pkl', 'rb') as f:
    ...
    # with open(r"./data/db2_data.pkl", "wb") as output_file:
    #     pickle.dump([train_data, valid_data, s1_data, s2_data], output_file)
    ...
    # model_bert.load_state_dict(torch.load("./trained_models/kiteddi_db2_U11_18_9794.pkl"), strict=False)
    model_bert.load_state_dict(torch.load("./trained_models/model_kiteddi_db2.pkl"))
    ...
    print('KITE_DDI: U2 | loss {} | acc{} | f1_micro {} | f1_macro {} '
          '| f1_weighted {} | MCC {}'.format(loss_U2, acc_U2, f1_micro2, f1_macro2, f1_avg2,
                                                    f1_bin2))
    ...
    print('KITE_DDI: U1 | loss {} | acc{} | f1_micro {} | f1_macro {} '
          '| f1_weighted {} | MCC {}'.format(loss_U1, acc_U1, f1_micro3, f1_macro3, f1_avg3,
                                                    f1_bin3))

    all_results.append([gt_U2, pred_U2, score_U2, gt_U1, pred_U1, score_U1])
