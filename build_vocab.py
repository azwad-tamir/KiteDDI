...
class Vocab(TorchVocab):
    def __init__(self, counter, max_size=None, min_freq=1):
        ...
        self.mask_index = 4
        self.sep_index = 5
        super().__init__(counter, specials=["<pad>", "<unk>", "<eos>", "<sos>", "<mask>", "<sep>"], max_size=max_size, min_freq=min_freq)
...
def main():
    ...
    parser.add_argument('--corpus_path', '-c', type=str, default='./data/db1_drugs_corpus.txt', help='path to the corpus')
    parser.add_argument('--out_path', '-o', type=str, default='./data/vocab_db1_drugs.pkl', help='output file')
    parser.add_argument('--min_freq', '-m', type=int, default=5, help='minimum frequency for vocabulary')
