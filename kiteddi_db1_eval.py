'''
This file evaluates the KiteDDI model on Dataset1
'''
...
def main():
    ...
    # model_bert.load_state_dict(torch.load("./trained_models/kiteddi_db1_U1_55_2550.pkl"), strict=False)
    model_bert.load_state_dict(torch.load("./trained_models/model_kiteddi_db1.pkl"), strict=False)
    ...
    print('KITEDDI: U2 | loss {} | acc{} | f1_micro {} | f1_macro {} '
          '| f1_weighted {} | MCC {}'.format(loss_U2, acc_U2, f1_micro2, f1_macro2, f1_avg2, f1_bin2))


    # Evaluating loss for BERT model:
    loss_U1, acc_U1, f1_micro2, f1_macro2, f1_avg2, f1_bin2, auc, gt_U1, pred_U1, score_U1 = evaluate(model_bert,
                                                                                            s2_loader,
                                                                                            )

    print('KITEDDI: U1 | loss {} | acc{} | f1_micro {} | f1_macro {} '
          '| f1_weighted {} | MCC {}'.format(loss_U1, acc_U1, f1_micro2, f1_macro2, f1_avg2, f1_bin2))

    all_results = [gt_U2, pred_U2, score_U2, gt_U1, pred_U1, score_U1]

    with open(r"./result/r_kiteddi_db1.pkl", "wb") as output_file:
